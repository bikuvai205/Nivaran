...
return (
  <div className="p-6 bg-rose-200 bg-opacity-70 min-h-screen overflow-hidden">
    {/* Fixed Header */}
    ...
    {/* Sidebar + Feeds */}
    <div className="flex flex-col md:flex-row mt-20 md:mt-16 gap-4">
      {/* Sidebar */}
      <div className="w-full md:w-1/4 bg-rose-50 bg-opacity-80 rounded-2xl p-5 shadow-lg border border-rose-100 space-y-4">
        <div>
      ...
      {/* Feeds */}
      <div className="w-full md:w-3/4 overflow-y-auto max-h-[calc(100vh-5rem)] space-y-6 px-0 md:px-6">
          ...
          <>
            {sortedComplaints.map((c) => (
              ...
              >
                ...
                {/* Metadata badges (always in one line) */}
<div className="flex flex-wrap gap-2 mt-2 mb-3">
  <div className="flex-1 min-w-[70px]">{getSeverityBadge(c.severity)}</div>

  <span
    className={`flex-1 min-w-[70px] h-8 flex items-center justify-center rounded-full text-xs font-medium text-center capitalize ${
      c.status === "Resolved"
