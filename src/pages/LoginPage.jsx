...
const LoginPage = () => {
  ...
  const [email, setEmail] = useState(''); // authority login
  ...
  const handleSubmit = async (e) => {
    ...
    } else if (role === 'citizen' && registering) {
      // You can implement citizen registration here
      setLoginMessage('Citizen registration not connected yet.');
    } else {
      setLoginMessage('Only admin and authority login are connected currently.');
    }
  };
